...
import DoctorDetailScreen from "./DetailDoctor";
import HospitalDetailScreen from "./DetailHospital";
...
const HomeStack = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    ...
    <Stack.Screen name="DetailDoctorScreen" component={DoctorDetailScreen} />
    <Stack.Screen name="DetailHospital" component={HospitalDetailScreen} />
  </Stack.Navigator>
);
...
const TaiKhoanStack = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    ...
    <Stack.Screen name="ChinhSuaPass" component={ChangePasswordScreen} />
  </Stack.Navigator>
);

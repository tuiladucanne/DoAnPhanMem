        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.formContainer}>
                ...
                <View style={styles.inputGroup}>
                    ...
                    <Picker selectedValue={selectedDoctor} style={styles.picker} onValueChange={(itemValue) => setSelectedDoctor(itemValue)}>
                ...
                <View style={styles.inputGroup}>
                    ...
                    <Picker selectedValue={selectedDate} style={styles.picker} onValueChange={(itemValue) => setSelectedDate(itemValue)}>
